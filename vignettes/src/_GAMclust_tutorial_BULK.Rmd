...
```{r, stats, message = F, warning = F, results = "hide", echo=FALSE}
...
```{r, example-module, out.width="80%", echo=FALSE, fig.align='center'} 
...
```{r, heatmap-module, fig.width=35, fig.height=7}
pheatmap::pheatmap(
...
Elapsed time: `r format(Sys.time() - startTime, digits=3)`.

Peak R memory usage: `r sprintf("%.1f GB", sum(gc()[,6])/1000)`
