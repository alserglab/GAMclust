...
reanalysis of metabolic regulation in Tabula Muris Senis single cell
RNA-seq data (mononuclear phagocyte subset), originally described in
[Gainullina et al](https://doi.org/0.1016/j.celrep.2023.112046).

The vignette requires about an hour of computational time and 16GB of
...
```
    ...
    # INFO [2026-07-16 11:31:53] Global metabolite network contains 6754 edges.

    # INFO [2026-07-16 11:31:53] Largest connected component of this global network contains 1397 nodes and 5139 edges.
...
```
    ...
    # INFO [2026-07-16 11:31:53] 1123 metabolic genes from the analysed dataset mapped to this component.
...
![plot of chunk plot-genes](GAMclust_tutorial_SC_files/plot-genes-1.png)
